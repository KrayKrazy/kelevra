    ...
    <section className="bg-[#0B1528] py-24 border-b border-slate-800/50">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        ...
        <div className="mb-12 border-l-2 border-[#D4AF37] pl-4">
          <h2 className="text-2xl md:text-3xl font-playfair font-medium text-[#D4AF37] mb-4">Metodologia de execução.</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-4 gap-0 border-t border-l border-slate-800/50">
          {steps.map((step, index) => (
            <div key={index} className="p-6 border-b border-r border-slate-800/50 hover:bg-slate-800/20 transition-colors">
              <div className="text-sm font-playfair font-bold text-[#D4AF37] mb-4">
                {step.num}
              </div>
